...
python3 train_DCMM.py test=True task=Catching_TwoStage num_envs=1 checkpoint_catching=assets/models/catch_two_stage.pth object_eval=True viewer=True imshow_cam=True

tensorboard --logdir=~/catch_it/outputs/Dcmm/
tensorboard --logdir=~/catch_it/outputs/Dcmm/2025-11-06/22:20:09/tb